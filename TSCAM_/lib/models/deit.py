...
class TSCAM(VisionTransformer):
    ...
    def forward(self, x, return_cam=False):
        ...
        x_patch = self.head(x_patch) # [B, num_classes, 14, 14]
        ...
        if self.training:
            ...
            cams = attn_weights.sum(0)[:, 0, 1:].reshape([n, h, w]).unsqueeze(1)# [:, 0, 1:] the third dimension begins from 1 as get rid of cls_token probability \
            # the 2nd dimension choose 1 as to choose cls_token since it denotes the latent relationship among features
